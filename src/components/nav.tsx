  ...
  return (
    <Link
      ...
      className={cn(
        ...
        checkActiveNav(href) ? "border-2 border-l-secondary-foreground" : "",
        "h-10 justify-start text-wrap rounded-md  px-6 ",
        subLink && "h-9 w-full border-l border-l-slate-500 px-2"
      )}
    ...
    <Collapsible defaultOpen={isChildActive}>
      <CollapsibleTrigger
        className={cn(
          ...
          "group h-10 w-full justify-start rounded-md px-6"
        )}
      >
        <div className="mr-2">{icon}</div>
        {title}
